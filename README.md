...
The dashboard website, contains individual pages for each plot and a means by which we can navigate between them. The landing page contains a summary of the analysis and images of all four plots which also serve as navigation to each plot's detail page. 
